...
export function PromoterInvoicesTab() {
  const mockPayments = [
    { id: 1, date: "15 Oct 2024", client: "SCI Horizon", description: "Vente sur plan - Lot A21", amount: "32 500,00 €", status: "Paid" },
    {
      id: 2,
      date: "10 Oct 2024",
      client: "M. et Mme Dupont",
      description: "Acompte réservation T4",
      amount: "15 000,00 €",
      status: "Pending",
    },
    { id: 3, date: "02 Oct 2024", client: "Investissement Sud", description: "Solde VEFA", amount: "148 000,00 €", status: "Paid" },
  ];
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Suivez les règlements VEFA et vos encaissements.</p>
      </div>
