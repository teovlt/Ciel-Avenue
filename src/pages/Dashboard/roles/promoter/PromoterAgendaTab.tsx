...
import { ChevronLeft, ChevronRight, MapPin, Clock, Calendar as CalendarIcon, Key, FileText, CheckCircle } from "lucide-react";

const mockAppointments = [
  {
    id: 1,
    date: 15,
    title: "Remise des clés Lot A12",
    client: "M. et Mme Dupont",
    time: "10:00",
    type: "livraison",
    location: "Résidence Les Pins",
  },
  { id: 2, date: 16, title: "Signature Notaire", client: "Maitre Laurent", time: "14:00", type: "notaire", location: "Office Notarial" },
  {
    id: 3,
    date: 18,
    title: "RDV Investisseur",
    client: "Investissement Sud",
    time: "09:00",
    type: "rendez-vous",
    location: "Bureau Commercial",
  },
  { id: 4, date: 22, title: "Remise des clés Lot B04", client: "M. Martin", time: "11:30", type: "livraison", location: "Résidence Océan" },
  { id: 5, date: 28, title: "Audit Chantier", client: "Maître d'œuvre", time: "15:00", type: "rendez-vous", location: "Chantier Les Pins" },
];

export function PromoterAgendaTab() {
    ...
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Pilotez vos signatures notaires, remises de clés et rendez-vous investisseurs.</p>
        </div>
