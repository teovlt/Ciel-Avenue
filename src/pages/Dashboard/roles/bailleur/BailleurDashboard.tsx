      ...
      <div className="border-b border-border bg-card/80 backdrop-blur-sm relative z-10">
        <div className="container mx-auto px-4 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 animate-fade-in-up">
            <div>
              <h1 className="text-3xl font-bold text-foreground">Tableau de bord Bailleur</h1>
              <p className="text-muted-foreground mt-1">Gérez vos locations et suivez les candidats.</p>
            </div>
