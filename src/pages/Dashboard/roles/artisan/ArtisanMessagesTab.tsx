...
export function ArtisanMessagesTab() {
  const mockMessages = [
    {
      id: 1,
      client: "Maître d'œuvre Durand",
      subject: "Chantier SDB - Validation plans",
      preview: "L'architecte d'intérieur a validé les plans d'implantation électrique et plomberie. Pouvez-vous confirmer votre dispo ?",
    ...
    },
    {
      id: 2,
      client: "Mme Leroy",
      subject: "Demande précision devis plomberie",
      preview: "Pourriez-vous détailler la marque de la robinetterie incluse dans l'option 2 du devis s'il vous plaît ?",
      date: "Hier, 14:30",
      unread: false,
    },
  ];
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Discutez avec vos clients ou le maître d'œuvre en charge du chantier.</p>
      </div>
