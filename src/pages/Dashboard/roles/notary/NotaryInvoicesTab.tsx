...
export function NotaryInvoicesTab() {
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-foreground">Vos Factures</h2>
        <p className="text-muted-foreground">Gérez la facturation de vos clients et le suivi des paiements.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {mockNotaryPayments.map((invoice) => (
