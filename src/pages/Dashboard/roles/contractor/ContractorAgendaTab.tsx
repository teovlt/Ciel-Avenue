...
const mockAppointments = [
  ...
  { id: 2, date: 15, title: "Réunion de Chantier", client: "SCI Les Mimosas", time: "11:00", type: "reunion", location: "Aubagne" },
  {
    id: 3,
    date: 18,
    title: "Réception Matériaux",
    client: "Fournisseur Point P",
    time: "09:00",
    type: "logistique",
    location: "Chantier Cassis",
  },
  { id: 4, date: 22, title: "Livraison Projet", client: "M. Dupont", time: "16:00", type: "livraison", location: "Aix-en-Provence" },
  { id: 5, date: 28, title: "SAV Dégât des eaux", client: "Résidence Le Parc", time: "10:30", type: "sav", location: "Marseille 12" },
];

export function ContractorAgendaTab() {
    ...
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Planifiez vos interventions, réunions de chantier et réceptions.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          <h3 className="font-bold text-lg px-1 flex items-center gap-2">
            <HardHat className="h-5 w-5 text-primary" /> À venir
          </h3>
