...
import { mockContractorPayments } from "../data/mockData";
...
export function ContractorPaymentsTab() {
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-foreground">Situations & Honoraires</h2>
        <p className="text-muted-foreground">Suivi de vos facturations chantiers.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">64 000,00 €</div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="border-border bg-card/80 backdrop-blur-sm">
        ...
        <CardContent>
          <div className="space-y-4">
            {mockContractorPayments.map((payment) => (
              <div
                key={payment.id}
