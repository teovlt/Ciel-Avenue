...
export function BrokerInvoicesTab() {
  const mockPayments = [
    {
      id: 1,
      date: "15 Oct 2024",
      client: "M. et Mme Leroy",
      description: "Honoraires de courtage prêt immobilier",
      amount: "2 500,00 €",
      status: "Paid",
    },
    {
      id: 2,
      date: "10 Oct 2024",
      client: "Lucien Rousseau",
      description: "Frais de dossier négociation",
      amount: "800,00 €",
      status: "Pending",
    },
    {
      ...
      date: "02 Oct 2024",
      client: "SCI Immotech",
      description: "Accompagnement financement pro",
      amount: "4 200,00 €",
      status: "Paid",
    },
  ];
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Suivez la facturation de vos honoraires de courtage.</p>
      </div>
