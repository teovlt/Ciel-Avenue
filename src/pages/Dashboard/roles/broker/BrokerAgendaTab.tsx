...
const mockAppointments = [
  {
    id: 1,
    date: 15,
    title: "Découverte Projet Client",
    client: "M. Leroy",
    time: "10:00",
    type: "decouverte",
  ...
  },
  {
    id: 2,
    date: 15,
    title: "RDV Partenaire Bancaire",
    client: "Directeur BNP",
    time: "14:30",
    type: "banque",
    location: "Agence BNP Centre",
  },
  { id: 3, date: 18, title: "Signature d'Offre", client: "Famille Dubois", time: "11:00", type: "signature", location: "Cabinet Courtage" },
  {
    id: 4,
    date: 22,
    title: "Analyse Capacité d'Emprunt",
    client: "Mme Martin",
    time: "09:30",
    type: "decouverte",
    location: "Cabinet Courtage",
  },
  { id: 5, date: 28, title: "Signature Notaire", client: "SCI Immotech", time: "16:00", type: "notaire", location: "Étude Notariale" },
];

export function BrokerAgendaTab() {
    ...
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Planifiez vos rendez-vous clients et partenaires bancaires.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          <h3 className="font-bold text-lg px-1 flex items-center gap-2">
            <Briefcase className="h-5 w-5 text-primary" /> À venir
          </h3>
