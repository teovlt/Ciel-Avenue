...
export function BrokerMessagesTab() {
  const mockMessages = [
    {
      id: 1,
      client: "Banque Courtois (Partenaire)",
      subject: "Nouvelles conditions prêt relais",
      preview: "Bonjour, veuillez trouver ci-joint nos barèmes actualisés pour les prêts relais ce trimestre...",
    ...
    },
    {
      ...
      subject: "Validation de l'offre de prêt",
      preview: "Nous avons bien reçu l'offre éditée par la banque. Devons-nous attendre les fameux 11 jours pour renvoyer ?",
      date: "Hier, 14:30",
      unread: false,
    },
  ];
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Échangez avec les acquéreurs et vos partenaires bancaires.</p>
      </div>
