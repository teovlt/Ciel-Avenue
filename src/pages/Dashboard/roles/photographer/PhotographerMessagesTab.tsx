...
export function PhotographerMessagesTab() {
  const mockMessages = [
    {
      id: 1,
      client: "Agence Orpi",
      subject: "Lien de téléchargement expiré",
      preview: "Bonjour, le lien Wetransfer pour les photos de la villa à Aix est expiré. Pouvez-vous le renvoyer ?",
    ...
    },
    {
      id: 2,
      client: "Mme Leroy",
      subject: "Disponibilité Shooting samedi matin",
      preview: "Seriez-vous libre ce samedi matin pour réaliser les prises de vue avant que la luminosité ne baisse ?",
      date: "Hier, 14:30",
      unread: false,
    },
  ];
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Échangez avec les agents immobiliers et propriétaires vendeurs.</p>
      </div>
