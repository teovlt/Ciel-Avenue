...
export function PhotographerInvoicesTab() {
  const mockPayments = [
    { id: 1, date: "15 Oct 2024", client: "Agence Orpi", description: "Shooting Villa 6 pièces (Aix)", amount: "350,00 €", status: "Paid" },
    {
      id: 2,
      date: "10 Oct 2024",
      client: "M. et Mme Leroy",
      description: "Prestation photos appartement",
      amount: "180,00 €",
      status: "Pending",
    },
    { id: 3, date: "02 Oct 2024", client: "SCI Immotech", description: "Pack Visite Virtuelle 360", amount: "450,00 €", status: "Paid" },
  ];
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Suivez vos encaissements et les acomptes de vos prestations photographiques.</p>
      </div>
