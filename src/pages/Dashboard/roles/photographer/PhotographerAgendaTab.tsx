...
import { ChevronLeft, ChevronRight, MapPin, Clock, Calendar as CalendarIcon, Camera, Image as ImageIcon, Video } from "lucide-react";
import { BookingActions } from "../shared/BookingActions";
const mockAppointments = [
  { id: 1, date: 15, title: "Shooting Maison de Maître", client: "Agence Orpi", time: "10:00", type: "shooting", location: "Marseille 08" },
  {
    id: 2,
    date: 16,
  ...
  { id: 3, date: 18, title: "Prise Drone Domaine", client: "SCI Sud", time: "09:00", type: "drone", location: "Cassis" },
  { id: 4, date: 22, title: "Shooting Studio", client: "M. Martin", time: "11:30", type: "shooting", location: "Aubagne" },
  { id: 5, date: 28, title: "Prise Drone Terrain", client: "Promoteur XYZ", time: "15:00", type: "drone", location: "Cévennes" },
];

export function PhotographerAgendaTab() {
    ...
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Planifiez vos shootings, visites virtuelles et prises drone.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          <h3 className="font-bold text-lg px-1 flex items-center gap-2">
            <Camera className="h-5 w-5 text-primary" /> À venir
          </h3>
