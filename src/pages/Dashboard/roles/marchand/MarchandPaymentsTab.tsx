...
import { mockMarchandPayments } from "../data/mockData";
import { Euro, ArrowUpRight, Clock } from "lucide-react";

export function MarchandPaymentsTab() {
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-foreground">Commissions & Honoraires</h2>
        <p className="text-muted-foreground">Suivi de vos encaissements.</p>
      </div>
      ...
      <Card className="border-border bg-card/80 backdrop-blur-sm">
        ...
        <CardContent>
          <div className="space-y-4">
            {mockMarchandPayments.map((payment) => (
              <div
                key={payment.id}
