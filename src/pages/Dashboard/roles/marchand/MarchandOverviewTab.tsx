...
import { mockMarchandOverview } from "../data/mockData";
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">4 types de prestations pour accompagner tous les besoins immobiliers.</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {mockMarchandOverview.map((item) => (
