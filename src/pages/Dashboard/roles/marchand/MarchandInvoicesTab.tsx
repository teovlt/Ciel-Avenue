...
// Note: Reusing expertClients mock for marchand to show payments
export function MarchandInvoicesTab() {
  const mockPayments = [
    {
      id: 1,
      date: "15 Oct 2024",
      client: "Jean Dupont",
      description: "Rénovation & Achat - Honoraires de conseil",
      amount: "1 500,00 €",
      status: "Paid",
    },
    {
      ...
      description: "Vente T3 - Commission",
      amount: "4 300,00 €",
      status: "Pending",
    },
    { id: 3, date: "02 Oct 2024", Point: "Marie Martin", description: "Étude projet d'investissement", amount: "800,00 €", status: "Paid" },
  ];
        ...
        {mockPayments.map((invoice) => (
          <Card key={invoice.id} className="border-border bg-card/80 backdrop-blur-sm overflow-hidden group">
            ...
            <CardContent className="p-6 space-y-4">
              ...
              <div>
                <h3 className="font-bold text-lg text-foreground">{invoice.client || invoice.Point}</h3>
