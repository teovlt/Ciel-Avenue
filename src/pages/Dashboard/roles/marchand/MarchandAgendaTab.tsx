...
import { ChevronLeft, ChevronRight, MapPin, Clock, Calendar as CalendarIcon, User, Search, Store } from "lucide-react";

const mockAppointments = [
  { id: 1, date: 15, title: "Visite Appartement T3", client: "Lucas D.", time: "10:00", type: "visite", location: "Paris 15ème" },
  {
    id: 2,
    date: 15,
    title: "Rendez-vous Notaire",
    client: "Maître Renaud",
    time: "14:30",
    type: "notaire",
    location: "Étude Renaud, Paris",
  },
  {
    id: 3,
    date: 18,
    title: "Estimation Maison",
    client: "Famille Martin",
    time: "11:00",
    type: "estimation",
    location: "Boulogne-Billancourt",
  },
  { id: 4, date: 22, title: "Prospection Quartier", client: "Équipe", time: "09:30", type: "prospection", location: "Levallois-Perret" },
  {
    id: 5,
    date: 28,
...
export function MarchandAgendaTab() {
    ...
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Planifiez vos visites, estimations et rendez-vous.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          <h3 className="font-bold text-lg px-1 flex items-center gap-2">
            <Store className="h-5 w-5 text-primary" /> À venir
          </h3>
