...
import { mockMarchandMissions } from "../data/mockData";
import { CheckCircle2 } from "lucide-react";

export function MarchandMissionsTab() {
  const missions = mockMarchandMissions;
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2 pt-2">
              <Button className="flex-1" size="sm">
                Proposer accompagnement ({mission.price})
              </Button>
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="mb-4">
        <h2 className="text-2xl font-bold text-foreground">Gestion des Missions Marchand</h2>
        <p className="text-muted-foreground">Suivez vos opérations d'achat/revente et gestion.</p>
      </div>
