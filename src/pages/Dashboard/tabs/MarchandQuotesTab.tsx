...
import { mockMarchandQuotes } from "../data/mockData";
import { FileText, Link as LinkIcon } from "lucide-react";

export function MarchandQuotesTab() {
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-2xl font-bold text-foreground">Vos Devis</h2>
          <p className="text-muted-foreground">Propositions d'accompagnement et mandats.</p>
        </div>
