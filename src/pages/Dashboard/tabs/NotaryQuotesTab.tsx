...
import { mockNotaryQuotes } from "../data/mockData";
import { FileText, Link as LinkIcon } from "lucide-react";

export function NotaryQuotesTab() {
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-2xl font-bold text-foreground">Vos Devis</h2>
          <p className="text-muted-foreground">Espace dédié à votre logiciel de devis.</p>
        </div>
