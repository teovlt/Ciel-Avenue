...
import { mockPromoterMissions } from "../data/mockData";
import { CheckCircle2 } from "lucide-react";

export function PromoterMissionsTab() {
  const missions = mockPromoterMissions;
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="mb-4">
        <h2 className="text-2xl font-bold text-foreground">Gestion des Missions Vente Neuf</h2>
        <p className="text-muted-foreground">Suivez vos dossiers acquéreurs.</p>
      </div>
