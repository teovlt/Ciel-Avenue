...
import { mockContractorQuotes } from "../data/mockData";
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-2xl font-bold text-foreground">Vos Devis MoE</h2>
          <p className="text-muted-foreground">Propositions d'honoraires et contrats.</p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        {mockContractorQuotes.map((quote) => (
